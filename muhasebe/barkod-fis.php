...
<main class="receipt">
  ...
  <div class="totals"><div class="total-row grand"><span>TOPLAM</span><strong><?php echo e(money((float)$sale['grand_total'])); ?></strong></div><div class="total-row"><span>Ödeme</span><strong><?php echo e($paymentLabels[$sale['payment_method']] ?? $sale['payment_method']); ?></strong></div></div>
