...
$logoSrc = 'assets/dumanlar-logo-arkaplansiz.png?v=1';
$machineSrc = 'assets/07DA19C3-9C50-4D7F-A2FB-922CC15BC158.PNG?v=1';
?>
<!doctype html>
<html lang="tr">
<head>
...
<style>
  *{box-sizing:border-box}
  ...
  .page{width:210mm;height:297mm;margin:14px auto;background:#fff;box-shadow:0 10px 28px rgba(0,0,0,.22);position:relative;overflow:hidden;border:1px solid #cfd5db;page-break-after:avoid;break-after:avoid}
  ...
  .hero-left{position:relative;padding:6mm 8mm 5mm 7mm;background:linear-gradient(108deg,#fff 0%,#fff 77%,transparent 77%);overflow:hidden}
  ...
  .real-logo{display:block;width:110mm;height:33mm;object-fit:contain;object-position:left center;position:relative;z-index:2}
  .hero-right{position:relative;overflow:hidden;background:var(--navy)}
  .hero-right img{width:100%;height:100%;object-fit:cover;display:block;filter:saturate(1.04) contrast(1.02)}
  .hero-right:before{content:'';position:absolute;left:-7mm;top:0;width:12mm;height:100%;background:linear-gradient(135deg,#f2d792,#a77b2e);transform:skewX(-18deg);z-index:2}
  .hero-right:after{content:'Üretim Gücümüz\A MAKİNE PARKURUMUZ';white-space:pre;position:absolute;right:8mm;bottom:8mm;text-align:center;color:#fff;font-weight:700;letter-spacing:.45mm;font-size:3.45mm;line-height:1.65;text-shadow:0 2px 8px rgba(0,0,0,.55);z-index:3}
  ...
  .bottom{position:absolute;left:0;right:0;bottom:0;height:38.5mm;overflow:hidden;page-break-inside:avoid;break-inside:avoid}.features{position:absolute;left:0;right:0;bottom:7.5mm;height:31mm;background:var(--navy);display:grid;grid-template-columns:1fr 1fr 1fr 52mm;align-items:center;gap:3mm;padding:4.5mm 10mm;color:#fff}.feature{display:grid;grid-template-columns:10mm 1fr;gap:2.3mm;align-items:center}.ficon{width:9.5mm;height:9.5mm;border:1.2px solid var(--gold);border-radius:50%;display:flex;align-items:center;justify-content:center;color:var(--gold);font-size:5mm}.feature b{display:block;color:var(--gold2);font-size:2.65mm;margin-bottom:.7mm}.feature span{display:block;font-size:2.25mm;line-height:1.18;color:#e7edf5}.thanks{border:1.1px solid var(--gold);border-radius:2mm;padding:4.5mm;text-align:center;color:var(--gold2);font-family:Georgia,serif;font-size:4mm;line-height:1.2;font-style:italic}.footer-band{position:absolute;left:0;right:0;bottom:0;height:7.5mm;background:linear-gradient(90deg,#f0c777,#f9e4a8,#f0c777);text-align:center;display:flex;align-items:center;justify-content:center;font-family:Georgia,serif;font-size:3.45mm;letter-spacing:.6mm;color:#513910}
  @page{size:A4;margin:0}
  @media print{html,body{width:210mm;height:297mm;background:#fff;overflow:hidden}.toolbar{display:none}.page{margin:0;border:0;box-shadow:none;width:210mm;height:297mm;page-break-after:avoid;page-break-inside:avoid;break-after:avoid;break-inside:avoid;overflow:hidden}.bottom,.features,.footer-band{page-break-inside:avoid;break-inside:avoid}.hero-right,.features,.footer-band,.items th,.total-line .label{print-color-adjust:exact;-webkit-print-color-adjust:exact}}
</style>
</head>
<body>
