...
<style>
  *{box-sizing:border-box}
  ...
  .hero{height:61mm;position:relative;background:#fff;overflow:hidden;border-bottom:1px solid #d9dce2}
  .hero-bg{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;object-position:center center;display:block;z-index:1}
  .real-logo{position:absolute;left:11mm;top:16mm;width:105mm;height:25mm;object-fit:contain;object-position:left center;z-index:3;display:block}
...
<body>
  ...
  <main class="page">
    <section class="hero">
      <img class="hero-bg" src="<?php echo e($machineSrc); ?>" alt="Dumanlar makine parkuru">
      <img class="real-logo" src="<?php echo e($logoSrc); ?>" alt="Dumanlar Çorap & Tekstil Üretimi">
    </section>
