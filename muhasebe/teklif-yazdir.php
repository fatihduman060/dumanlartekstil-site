...
$logoSrc = 'assets/dumanlar-logo-arkaplansiz.png?v=2';
$machineSrc = 'assets/07DA19C3-9C50-4D7F-A2FB-922CC15BC158.PNG?v=2';
?>
<!doctype html>
<html lang="tr">
<head>
...
<style>
  *{box-sizing:border-box}
  ...
  .page{width:210mm;height:296.5mm;margin:14px auto;background:#fff;box-shadow:0 10px 28px rgba(0,0,0,.22);position:relative;overflow:hidden;border:1px solid #cfd5db;page-break-after:avoid;break-after:avoid}
  ...
  .bottom{position:absolute;left:0;right:0;bottom:0;height:38.5mm;overflow:hidden;page-break-inside:avoid;break-inside:avoid;background:var(--navy)}
  .features{position:absolute;left:0;right:0;top:0;height:38.5mm;background:var(--navy);display:grid;grid-template-columns:1fr 1fr 1fr 52mm;align-items:center;gap:3mm;padding:4.2mm 10mm 11mm;color:#fff;overflow:hidden}
  ...
  .footer-band{position:absolute;left:0;right:0;bottom:0;height:7.5mm;background:linear-gradient(90deg,#f0c777,#f9e4a8,#f0c777);text-align:center;display:flex;align-items:center;justify-content:center;font-family:Georgia,serif;font-size:3.45mm;letter-spacing:.6mm;color:#513910;z-index:5}

  @page{size:A4;margin:0}
  @media print{html,body{width:210mm;height:296.5mm;background:#fff;overflow:hidden}.toolbar{display:none}.page{margin:0;border:0;box-shadow:none;width:210mm;height:296.5mm;page-break-after:avoid;page-break-inside:avoid;break-after:avoid;break-inside:avoid;overflow:hidden}.bottom,.features,.footer-band{page-break-inside:avoid;break-inside:avoid}.hero,.hero-right,.features,.footer-band,.items th,.total-line .label{print-color-adjust:exact;-webkit-print-color-adjust:exact}}
</style>
</head>
<body>
