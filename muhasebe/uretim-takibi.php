...
?>
<script defer src="assets/uretim-fotograf-core.js?v=1"></script>
<script defer src="assets/uretim-fotograf.js?v=1"></script>
<script src="assets/uretim-hizli-giris.js?v=4"></script>
<script src="assets/uretim-vardiya-ayri-kaydet.js?v=4"></script>
<style>
    ...
    <form method="post" action="uretim-hizli-kaydet.php" data-shift-form>
      ...
      <div class="shift-grid">
        ...
        <section class="shift-card" data-shift="<?php echo e($shiftCode); ?>">
          ...
          <div style="padding:14px" data-photo-panel>
            <button type="button" data-photo-read>Fotoğraftan Oku</button>
            <input type="file" data-photo-file accept="image/jpeg,image/png" hidden aria-label="<?php echo e($shiftTitle); ?> fotoğrafı">
            <p>JPEG, PNG veya ekran görüntüsü (en fazla 15 MB). Yalnız bu vardiya doldurulur. Net, tek vardiyalık tablo yükleyin; el yazısı ve bulanık görseller eksik okunabilir.</p>
            <p data-photo-status role="status" aria-live="polite">Sonuçları kontrol ettikten sonra vardiyayı kaydedin.</p>
            <img data-photo-preview hidden alt="Kontrol için yüklenen vardiya fotoğrafı" style="max-width:100%;max-height:320px;object-fit:contain">
          </div>
