...
$balanceSummary = depo_cikis_balance_summary($row);
$rows = $row['items'] ?? [];
...
/* Long dispatches must grow; the footer must never cover totals or notes. */
.page{height:auto;min-height:297mm;overflow:visible;display:flex;flex-direction:column}
.content{padding-bottom:8mm}
.bottom{position:relative;left:auto;right:auto;bottom:auto;flex-shrink:0;margin-top:auto}
.balance-summary{margin:4mm 0 0 auto;width:85mm;max-width:100%;border:1px solid var(--gold);border-radius:2mm;padding:2mm 3mm;break-inside:avoid;page-break-inside:avoid}
.balance-row{display:flex;justify-content:space-between;gap:4mm;padding:1.2mm 0;font-size:3mm}
.balance-row strong{white-space:nowrap}
.balance-row:last-of-type{border-top:1px solid var(--line);font-weight:900}
.balance-note{font-size:2.3mm;line-height:1.3;margin:1.5mm 0 0;color:#465268}
@media print{
  html,body{height:auto!important;overflow:visible!important}
  .page{display:block;height:auto!important;min-height:297mm;overflow:visible!important}
  .content{padding-bottom:7mm!important}
  .bottom{position:relative;break-inside:avoid;page-break-inside:avoid}
  table.items{overflow:visible}
  .items thead{display:table-header-group}
  .items tr,.note{break-inside:avoid;page-break-inside:avoid}
}
</style>
</head>
<body>
...
<section class="balance-summary" aria-label="Cari bakiye özeti">
