...
<section class="stats-grid five report-block report-position-grid">
  <article class="stat-card status report-hero-stat"><span>Genel Durum</span><strong class="<?php echo $reportNetPosition>=0?'text-success':'text-danger'; ?>"><?php echo e(money($reportNetPosition)); ?></strong><small>Ham net cari bakiye</small></article>
  <article class="stat-card"><span>Kalan alacak</span><strong><?php echo e(money($reportRemainingReceivable)); ?></strong><small><?php echo $reportOverCollected > 0 ? 'Fazla tahsilat/avans: ' . e(money($reportOverCollected)) : 'Alacak - tahsilat'; ?></small></article>
  <article class="stat-card"><span>Kalan verecek</span><strong><?php echo e(money($reportRemainingPayable)); ?></strong><small><?php echo $reportOverPaid > 0 ? 'Fazla ödeme/avans: ' . e(money($reportOverPaid)) : 'Verecek - ödeme'; ?></small></article>
...
<p class="calc-note report-calc-note"><strong>Okuma notu:</strong> Kalan alacak/verecek eksi gösterilmez; fazla tahsilat veya fazla ödeme varsa avans gibi küçük yazıda görünür. Genel Durum ham net cari bakiyedir. Nakit Neti = vade/tahsil tarihine göre giren para - çıkan para. Bekleyen çekler nakit sayılmaz. Özel Alacak bu iki hesaba dahil edilmez.</p>
