...
function page_footer(): void
{
  ...
  <script src="assets/cek-vade-uyari.js?v=5"></script>
  ...
  <script src="assets/fatura-kdv-devir.js?v=2"></script>
  ...
  <script src="assets/fatura-iade-turu.js?v=11"></script>
  ...
  <script src="assets/cek-kapali-ayir.js?v=2"></script>
  ...
  <script src="assets/hesap-banka-detay.js?v=3"></script>
  <?php endif; ?>
