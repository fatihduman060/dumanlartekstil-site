...
(function(){
  ...
  var columns=grid&&grid.querySelector('.salary-columns');
  if(!columns) return;
  var monthly=grid.querySelector('.salary-records-card');
  var employees=grid.querySelector('.salary-employee-card');
  var advance=grid.querySelector('.salary-advance-card');
  var garnishment=grid.querySelector('.salary-garnishment-card');
  [monthly,employees,advance,garnishment].forEach(function(section){
    if(section) columns.appendChild(section);
  });
})();
