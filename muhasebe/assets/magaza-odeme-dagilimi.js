(function(){
  ...
  function updatePreview(){
    ...
    preview.innerHTML=''
      ...
      +'<em>Nakit aynı gün Mağaza Kasa’ya girer. Kart/POS tutarı satıştan 13 gün sonra Garanti Dumanlar’a işlenir. Veresiye satış ve bozuk para hesaplara aktarılmaz.</em>';
  }
  ...
  function buildPanel(){
    ...
    panel.innerHTML=''
      +'<div class="magaza-odeme-head"><div><strong>Günlük Satış Dağılımı</strong><small>Nakit girişler aynı gün Mağaza Kasa’ya; kart/POS girişleri 13 gün sonra Garanti Dumanlar hesabına otomatik işlenir. Veresiye satış ve kasada bırakılan bozuk para aktarılmaz.</small></div><span data-magaza-odeme-status></span></div>'
  ...
  function render(data){
    ...
    setStatus((summary.count||0)+' gün · nakit Mağaza Kasa’ya aynı gün · kart Garanti’ye 13 gün sonra','success');updatePreview();var activeDate=form?qs('[name="sale_date"]',form):null;if(activeDate) loadPreviousCashChange(activeDate.value);
