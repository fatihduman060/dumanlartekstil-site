(function(){
  ...
  style.textContent=''
    ...
    +'.fatura-list-only .table-wrap{width:100%;overflow-x:auto}'
    +'.fatura-list-only table{width:100%;min-width:0!important;table-layout:fixed;font-size:10px}'
    +'.fatura-list-only table th,.fatura-list-only table td{padding:8px 5px;vertical-align:middle;line-height:1.18;overflow-wrap:anywhere;word-break:normal}'
    +'.fatura-list-only table th{font-size:8.5px;letter-spacing:.02em}'
    +'.fatura-list-only table td strong{font-size:10px;line-height:1.16}'
    +'.fatura-list-only table td small{font-size:7.5px;line-height:1.15;margin-top:2px}'
    +'.fatura-list-only table th:nth-child(1),.fatura-list-only table td:nth-child(1){width:11%}'
    +'.fatura-list-only table th:nth-child(2),.fatura-list-only table td:nth-child(2){width:8%}'
    +'.fatura-list-only table th:nth-child(3),.fatura-list-only table td:nth-child(3){width:18%;font-size:9.5px}'
    +'.fatura-list-only table th:nth-child(4),.fatura-list-only table td:nth-child(4){width:14%}'
    +'.fatura-list-only table th:nth-child(5),.fatura-list-only table td:nth-child(5){width:11%}'
    +'.fatura-list-only table th:nth-child(6),.fatura-list-only table td:nth-child(6){width:10%}'
    +'.fatura-list-only table th:nth-child(7),.fatura-list-only table td:nth-child(7){width:14%}'
    +'.fatura-list-only table th:nth-child(8),.fatura-list-only table td:nth-child(8){width:7%}'
    +'.fatura-list-only table th:nth-child(9),.fatura-list-only table td:nth-child(9){width:7%}'
    +'.fatura-list-only table td:nth-child(3) a{font-size:9.5px;line-height:1.15}'
    +'.fatura-list-only .fatura-issuer-line{font-size:7.5px!important;line-height:1.12}'
    +'.fatura-list-only .fatura-tur-button{min-width:0!important;max-width:none!important;width:100%;padding:5px 6px}'
    +'.fatura-list-only .fatura-tur-button strong{font-size:8.5px!important}'
    +'.fatura-list-only .fatura-tur-button small{font-size:7px!important}'
    +'.fatura-list-only .row-actions{gap:4px;align-items:flex-start}'
    +'.fatura-list-only .row-actions a,.fatura-list-only .row-actions button{font-size:8px;line-height:1.1;padding:0}'
    ...
    +'@media(max-width:900px){.fatura-list-only table{min-width:760px!important}.fatura-list-only table th,.fatura-list-only table td{padding:7px 4px}.fatura-list-only table td:nth-child(3),.fatura-list-only table td:nth-child(3) a{font-size:9px}}'
    +'@media(max-width:720px){.toplu-yon-duzelt-panel{grid-template-columns:1fr}.toplu-yon-actions{justify-content:flex-start}.fatura-list-only table{min-width:720px!important}}';
