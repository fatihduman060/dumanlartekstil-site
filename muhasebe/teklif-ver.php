        ...
        <div class="offer-table-wrap">
          <table class="offer-table" id="offerRows">
            ...
            <tbody>
              ...
              <tr>
                <td><input name="product_name[]" list="productOptions" class="product-name" value="<?php echo offer_item_value($items, $i, 'product_name'); ?>" placeholder="Listeden seç veya elle yaz"></td>
